        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">Campus Event Hub</span>
            </div>
            <p className="text-gray-300 mb-4 max-w-md">
              Connect, discover, and participate in amazing campus events. 
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/events?upcoming=true" className="text-gray-300 hover:text-white transition-colors">
                  Upcoming Events
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2024 Campus Event Hub. All rights reserved.
            </p>
